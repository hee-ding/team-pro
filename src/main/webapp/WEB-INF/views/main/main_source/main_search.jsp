	...
	<div class="row">
		...
		<div class="col-md-4">
              <div class="row text-center op-7 w-50 float-end">
                <div class="col p-0"> <a href="/facility" class="text-dark text-decoration-none"> <i class="bi bi-lungs" style="font-size: 1.5em;"></i> <span class="d-block" style="font-size: 0.8em;">운동시설</span></a> </div>
